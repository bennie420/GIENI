...
import ParcelConsole from './ParcelConsole';
...
export default function InvestigationTab({
  ...
  return (
    <div>
      ...
      {/* Feature RC-002: Authority Timeline */}
      <AuthorityTimeline probateCase={currentCase} authority={currentAuthority} />

      {/* Feature RC-003: Parcel Console */}
      <ParcelConsole currentParcel={currentParcel} currentOwnership={currentOwnership} />
    </div>
  );
}
