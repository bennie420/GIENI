...
export type DeedType = 'WARRANTY_DEED' | 'GRANT_DEED' | 'QUITCLAIM_DEED' | 'SPECIAL_WARRANTY_DEED' | 'DEED_OF_TRUST' | 'MORTGAGE' | 'PROBATE_ORDER' | 'AFFIDAVIT_DEATH_JOINT_TENANT' | 'OTHER';
