...
function calculateOpportunityScore(id, input) {
    ...
    const rawWeightedScore = authorityComponent * 0.35 +
    ...
    return {
        ...
        priorityBand,
        breakdown,
        ruleVersion: exports.SCORING_RULE_VERSION,
        evaluatedAt,
        schemaVersion: 1,
    };
}
